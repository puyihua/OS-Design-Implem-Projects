...
bootsplash.img: bootsplash.S
	...
	objcopy -O binary bootsplashlinked.o bootsplash0.img
	dd if=bootsplash0.img of=bootsplash.img bs=512 count=1
	dd if=cover.raw of=bootsplash.img bs=512 seek=1 count=125
